...
using EF_DBFirst.Providers;
using EF_DBFirst.Results;
using EF_DBFirst;
...
namespace EF_DBFirst.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController()
        {
            ...
            using (Entities2 en =new Entities2())
            {
                User a = new User();
                a.id = 1;
                a.Name = "long";
                ...
                int result = en.SaveChanges();
                //var result1 = from c in   a   where c.Name = "long" select c;
            }
        }
